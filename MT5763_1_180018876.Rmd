...
seoul_model <- lm(formula = log(Count + 1) ~ Spring + Summer + Winter + Temperature + Humidity + WindSpeed, data = seoul_model_dataset)
summary(seoul_model)
```
...
par(mfrow = c(2,2))
plot(seoul_model, main = "Seoul Diagnostics")
```
