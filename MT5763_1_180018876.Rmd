...
Here we used `r lm(formula = ..., data = ...)` to fit a model to the Seoul data. 
```{r linear_seoul}
...
seoul_model <- lm(formula = log(Count + 1) ~ Season + Temperature + Humidity + WindSpeed, data = seoul_model_dataset)
summary(seoul_model)
```
